...
const PortlandTimbersPage = () => {
  const [activeTab, setActiveTab] = useState('overview');

  const trendingPlayers = [
    { 
      name: 'Kamal Miller', 
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-OBTzPwXJxDw2RoBTT0Dar4Hkhlwac4hafA&s', 
      slug: 'kamal' 
    },
    { 
      name: 'Diego Chará', 
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZvPs48qADU-UwzRq223yrcFLu4lA2db6cfQ&s', 
      slug: 'chara' 
    },
  ];
  ...
  const squad = {
    goalkeepers: ["Aljaž Ivačič", "David Bingham"],
    defenders: ["Kamal Miller", "Larrys Mabiala", "Juan David Mosquera", "Zachary McGraw"],
    midfielders: ["Diego Chará", "Cristhian Paredes", "Eryk Williamson", "David Ayala"],
    attackers: ["Felipe Mora", "Jonathan Rodríguez", "Santiago Moreno"],
  };
  ...
  return (
    <div className="bg-white min-h-screen text-[#0d1117]">
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="flex items-center gap-5 md:gap-6 mb-4">
              <div className="w-24 h-24 md:w-40 md:h-40 relative bg-white rounded-2xl p-4 shadow-2xl flex items-center justify-center">
                <Image
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Portland_Timbers_logo.svg/330px-Portland_Timbers_logo.svg.png"
      ...
      {/* Tabs - Zelena boja Portland Timbersa */}
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-10 md:space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-6 md:p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg">
                  <div><dt className="font-bold text-gray-600">Full Name</dt><dd>Portland Timbers</dd></div>
                  <div><dt className="font-bold text-gray-600">Nickname</dt><dd>The Timbers</dd></div>
                  <div><dt className="font-bold text-gray-600">Founded</dt><dd>2009</dd></div>
                  <div><dt className="font-bold text-gray-600">Stadium</dt><dd>Providence Park, Portland, Oregon</dd></div>
                  <div><dt className="font-bold text-gray-600">Capacity</dt><dd>25,218</dd></div>
                  <div><dt className="font-bold text-gray-600">Head Coach</dt><dd>Phil Neville</dd></div>
                </dl>
              </div>

              <div>
                <h2 className="text-3xl font-black mb-6 text-[#020617]">A Legacy of Passion and Tradition</h2>
                <div className="prose max-w-none text-lg text-gray-800">
                  <p>The Portland Timbers are one of Major League Soccer’s most iconic clubs, famous for their passionate “Timbers Army” supporters and electric atmosphere at Providence Park.</p>
                  <p>Known for their gritty, hardworking style and strong community ties, the Timbers have built a proud identity in the Pacific Northwest. With key players like Diego Chará and Kamal Miller, they continue to compete at a high level in the Western Conference.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {trendingPlayers.map((player) => (
                    <Link key={player.slug} href={`/teams/portland-timbers/${player.slug}`} className="group">
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">Portland Timbers Squad</h2>
          ...
          {activeTab === 'shop' && (
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl font-black text-[#020617]">Portland Timbers Shop</h2>
              </div>

              <p className="text-lg text-gray-600 mb-10">
                Support the Timbers by shopping through our links. 
              ...
              <div className="mt-12 text-center">
                ...
                >
                  View full Portland Timbers store →
                </a>
              </div>
            </div>
          )}
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-emerald-600 to-green-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              <a href="https://ticketnetwork.lusg.net/9LnXMY" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://www.booking.com" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
                <FaBed /> Hotels Near Providence Park
              </a>
            </div>
          </div>
...
export default PortlandTimbersPage;