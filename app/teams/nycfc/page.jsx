...
const NYCFCPage = () => {
  ...
  const trendingPlayers = [
    { 
      name: 'Maxi Moralez', 
      image: 'https://cdn.eleco.com.ar/media/2022/12/deportes_32.jpg', 
      slug: 'moralez' 
    },
    { 
    ...
    { 
      name: 'Monsef Bakrar', 
      image: 'https://www.telegram.hr/wp-content/uploads/2024/12/monsef-bakrar.jpg', 
      slug: 'bakrar' 
    },
  ];
  ...
  const blogPosts = [
    {
      id: 1,
      title: "NYCFC Deliver Impressive Performance in 2026 Season",
      author: "Mio Ristić",
      date: "March 25, 2026",
      excerpt: "New York City FC continue their strong campaign with standout performances from key players.",
      imageUrl: "https://assets.goal.com/images/v3/getty-2150744981/crop/MM5DGOBYHA5DEMJYG45G433XMU5DOMBSHIYTANQ=/GettyImages-2150744981.jpg",
      slug: "nycfc-strong-2026",
    },
  ];
  ...
  const squad = {
    goalkeepers: ["Matt Freese", "Tomas Romero"],
    defenders: ["Thiago Martins", "Maxi Moralez", "Mitja Ilenič", "Kevin O'Toole"],
    midfielders: ["Santiago Rodríguez", "James Sands", "Keaton Parks", "Andrés Perea"],
    attackers: ["Monsef Bakrar", "Julián Fernández", "Agustín Ojeda"],
  };
    ...
    <div className="bg-white min-h-screen text-[#0d1117]">
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="flex items-center gap-5 md:gap-6 mb-4">
              <div className="w-24 h-24 md:w-40 md:h-40 relative bg-white rounded-2xl p-4 shadow-2xl flex items-center justify-center">
                <Image
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Logo_New_York_City_FC_2025.svg/330px-Logo_New_York_City_FC_2025.svg.png"
              ...
              <div>
                ...
                <p className="text-lg md:text-xl text-white/90 mt-1 font-medium">
                  Major League Soccer • Yankee Stadium
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-10 md:space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-6 md:p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg">
                  <div><dt className="font-bold text-gray-600">Full Name</dt><dd>New York City Football Club</dd></div>
                  <div><dt className="font-bold text-gray-600">Nickname</dt><dd>NYCFC</dd></div>
                  <div><dt className="font-bold text-gray-600">Founded</dt><dd>2013</dd></div>
                  <div><dt className="font-bold text-gray-600">Stadium</dt><dd>Yankee Stadium, The Bronx, New York</dd></div>
                  <div><dt className="font-bold text-gray-600">Capacity</dt><dd>33,000</dd></div>
                  <div><dt className="font-bold text-gray-600">Owner</dt><dd>City Football Group</dd></div>
                  <div><dt className="font-bold text-gray-600">Head Coach</dt><dd>Pascal Jansen</dd></div>
                </dl>
              </div>

              <div>
                <h2 className="text-3xl font-black mb-6 text-[#020617]">A Modern Force in MLS</h2>
                <div className="prose max-w-none text-lg text-gray-800">
                  <p>New York City FC, founded in 2013 as a sister club to Manchester City, has quickly established itself as one of the most exciting teams in Major League Soccer.</p>
                  <p>Playing at the historic Yankee Stadium, NYCFC combines technical, attacking football with the energy of New York City. The club has already won an MLS Cup and continues to attract top talent from around the world.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {trendingPlayers.map((player) => (
                    <Link key={player.slug} href={`/teams/nycfc/${player.slug}`} className="group">
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">New York City FC Squad</h2>
          ...
          {activeTab === 'shop' && (
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl font-black text-[#020617]">NYCFC Shop</h2>
              </div>

              <p className="text-lg text-gray-600 mb-10">
                Support New York City FC by shopping through our links. 
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              <a href="https://ticketnetwork.lusg.net/jeQvzb" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://www.booking.com" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
                <FaBed /> Hotels Near Yankee Stadium
              </a>
            </div>
          </div>
